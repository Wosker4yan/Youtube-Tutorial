...
@author: Vahram
"""
"WORKING SIMULATION PLEASE DON'T CHANGE"
"""!!!!!!"""
...
for angle in angles:
    with nd.Cell(name='topcell') as topcell:
        ...
        strt3= ic.strt(length =length_arm_down, width=w1).put(e7.pin['b0'])
        strt4= ic.strt(length =length_arm_down, width=w1).put(e8.pin['b0'])
    ...
    fdtd = lumapi.FDTD()
    fdtd.switchtolayout;
    fdtd.feval('GDS_2_FDTD_SiN');
    
    
    Thickness_Si = maxvzWAFER
    fdtd.setglobalsource("wavelength start",1300e-9) #wavelength start must be lower than wavelength stop
